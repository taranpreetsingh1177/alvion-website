                        ...
                        {founders.map((founder, index) => (
                            <div key={index} className="flip-card h-[420px]">
                                <div className="flip-card-inner">
                                    ...
                                    {/* Back Side */}
                                    <div className="flip-card-back border-2 border-[#FFD700] p-5 flex flex-col shadow-xl bg-white relative">
                                        ...
                                        <div className="overflow-y-auto flex-1 pr-1 scrollbar-thin-dark">
                                            ...
                                            <div className="flex items-center gap-3 mb-3">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-[#0a1b2b] text-base">{founder.name}</h4>
                                            ...
                                            <div className="mb-2">
                                                ...
                                                <p className="text-xs text-slate-600">{founder.education}</p>
                                            </div>
